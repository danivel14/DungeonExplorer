export const GameStory = [
    {
        title: "El Reino de Valtheria",
        text: "Hace siglos, Valtheria era una tierra de equilibrio entre magia y ciencia, gracias al Corazón de Aether en la Torre del Núcleo.",
        bg: require('../../assets/images/Exterior.png')
    },
    {
        title: "La Corrupción",
        ...
        bg: require('../../assets/images/entrada.png') 
    },
    {
